...
Сервер после проверки остановлен. Последняя успешная проверка чистой базы была на `http://localhost:5000`.
...
5. Добавить просмотр/редактирование текстового контента страниц через админку.
6. Добавить локальные изображения вместо внешних временных URL.
7. Добавить управление текстовым контентом страниц через админку.
