...
- `/admin` — разделы сайта
- `/admin/leads` — заявки
- `/admin/profile` — профиль администратора и смена пароля
...
Заголовки, описания hero-блоков, CTA и часть секционных текстов публичных страниц берутся из таблицы `PageContentBlocks`, поэтому изменения в разделе «Тексты» отображаются на сайте без правки Razor-файлов.
